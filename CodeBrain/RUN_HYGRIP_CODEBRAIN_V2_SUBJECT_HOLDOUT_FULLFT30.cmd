...
"%PYTHON%" -u run_hygrip_codebrain.py --model codebrain --prepared-root D:\data\HYGRIP-Baselines\prepared_eeg_v2 --train-subjects A-J --val-subjects K-L --test-subjects M-N --fine-tune-backbone --epochs 30 --batch-size 4 --head-lr 0.0001 --backbone-lr 0.00001 --weight-decay 0.0005 --dropout 0.5 --seed 1 --device cuda --output-dir D:\data\HYGRIP-Baselines\CodeBrain\run_hygrip_codebrain_v2_subject_holdout_fullft30_seed1
